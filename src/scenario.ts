...
export async function updateScenario(formData: UpdateScenarioRequest): Promise<Response> {
...
export async function deleteScenario(formData: DeleteScenarioRequest): Promise<Response> {
